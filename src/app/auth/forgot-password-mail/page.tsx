...
import AuthForgotPasswordMail from "../authforms/AuthForgotPasswordMail";
export const metadata: Metadata = {
  title: "Boxed Login Authentication",
  description: "Generated by create next app",
};
const BoxedForgotPasswordMail = () => {
...
export default BoxedForgotPasswordMail;
