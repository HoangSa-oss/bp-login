...
import AuthVerifyUser from "../authforms/AuthVerifyUser";
export const metadata: Metadata = {
  title: "Boxed Login Authentication",
  description: "Generated by create next app",
};
const BoxedVerifyUser = () => {
        ...
        <div className="flex h-full justify-center items-center px-4">
          <div className="rounded-lg dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-6 relative w-full break-words md:w-[450px] w-full border-none ">
            <div className="flex h-full flex-col justify-center gap-2 p-0 w-full">
              ...
              <p className="text-sm text-center text-dark my-3"><span>Verify user is processing</span></p> 
              <AuthVerifyUser />
            </div>
          </div>
        </div>
...
export default BoxedVerifyUser
